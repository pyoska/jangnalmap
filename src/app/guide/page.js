    ...
    <div className="min-h-screen bg-white text-[#1A1A1A] flex flex-col antialiased">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-4 py-12 flex flex-col gap-8">
        ...
        <section className="space-y-6 text-sm text-gray-600 leading-relaxed font-medium">
          ...
          <p>
            우리나라의 전통 5일장은 보통 일의 자리 날짜를 기준으로 5일마다 열리는 주기법을 가지고 있습니다.
            예를 들어 개설 주기가 &apos;2일, 7일&apos;로 표기된 시장은 매달 2일, 7일, 12일, 17일, 22일, 27일에 어김없이 장이 열려요.
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>온누리상품권 사용하기:</strong> 모바일 및 카드형 온누리상품권은 평시에도 10% 할인 충전 혜택을 받을 수 있고, 연말정산 시 전통시장 소득공제 40%가 적용되어 지출을 대폭 아낄 수 있어요.</li>
