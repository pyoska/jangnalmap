...
const ARTICLES = {
  'onnuri': {
    title: '모바일 온누리상품권 사용처 가맹점 안내 & 10% 충전 할인법 | 장날맵',
    seoTitle: '모바일 온누리상품권 사용처 가맹점 안내 & 10% 충전 할인법 | 장날맵',
    description: '충전식 카드형 모바일 온누리상품권 가입 구매 방법, 10% 특별 선할인 팁 및 전통시장 연말정산 소득공제 40% 적용 혜택 상세 가이드.',
    category: '금융/할인 꿀팁',
    date: '2026.07.24',
    readTime: '4분',
    contentHtml: `
      <div class="space-y-6">
        <p class="text-base text-gray-700 leading-relaxed">
          요즘 시장에서 장볼 때 이거 안 쓰면 진짜 바보 소리 들어요! 바로 <strong>모바일(카드형) 온누리상품권</strong>인데요. 앱 켜고 충전만 하면 무조건 <strong>10% 할인</strong> 혜택이 꽂힙니다. 저도 처음에 긴가민가했는데 진짜배기더라고요!
        </p>
        <p class="text-base text-gray-700 leading-relaxed">
          간단히 말해서 10만 원어치를 9만 원만 내고 충전해서 시장 통닭집, 반찬가게에서 척척 결제하는 거죠. 장바구니 물가 팍팍 줄여주는 이만한 쏠쏠한 생활 꿀팁이 또 어딨나요!
        </p>
